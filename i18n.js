...
const TRANSLATIONS = {
  fr: {
    ...
    settingsTitle: 'Paramètres - TabPulse',
  ...
  en: {
    ...
    saveBtn: 'Save',
    resetBtn: '↻ Reset',
    settingsTitle: 'Settings - TabPulse',
  ...
  ru: {
    ...
    saveBtn: 'Сохранить',
    resetBtn: '↻ Сброс',
    settingsTitle: 'Настройки - TabPulse',
  ...
  es: {
    ...
    saveBtn: 'Guardar',
    resetBtn: '↻ Reiniciar',
    settingsTitle: 'Configuración - TabPulse',
